		...
		//Step 2: drop tables
  		...
  		sql = "CREATE TABLE RESTAURANTS "
  		 ...
  		 sql = "CREATE TABLE USER_VISIT_HISTORY "
  				 + " (visit_history_id bigint(20) "
  				 + " unsigned NOT NULL AUTO_INCREMENT, user_id VARCHAR(255) "
  				 + "NOT NULL , business_id VARCHAR(255) NOT NULL, "
  				 + "last_visited_time timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,"
  				 + "PRIMARY KEY (visit_history_id), FOREIGN KEY (business_id) "
  				 + "REFERENCES RESTAURANTS(business_id),FOREIGN KEY (user_id) "
  		...
  		BufferedReader reader = new BufferedReader(new FileReader(
  		  		"/Users/fanyang/Downloads/laioffer_software/yelp_dataset-master/business_small.json"));//replace with your real physical path. 
